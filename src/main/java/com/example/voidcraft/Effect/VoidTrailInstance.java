...
public class VoidTrailInstance {
    ...
    public static final class Preset {
        ...
        public static final class Builder {
            ...
            private float minMoveDistance = 0.012F; // 单次累计位移达到这个阈值后才释放采样点，越小越容易补点。
            private float pointSpacing = 0.055F; // 连续轨迹带的补点间距，越小越连续，采样密度也越高。
            private int maxInterpolationSteps = 8; // 单次补点最多插多少段，避免高速实体一次补出过多点。
            ...
            private int ribbonFadeSegments = 5; // 边缘渐隐细分段数，越高越平滑，也越吃透明填充性能。
            ...
            private float shaderCompatVerticalGlowGain = 1.80F; // 光影兼容下竖向柔光亮度增益。
            private float shaderCompatVerticalCoreGain = 1.72F; // 光影兼容下竖向主体亮度增益。
            private float shaderCompatSideGlowGain = 2.22F; // 光影兼容下侧向柔光亮度增益。
            private float shaderCompatSideCoreGain = 2.05F; // 光影兼容下侧向主体亮度增益。
            private float shaderCompatBloomAlphaScale = 1.0F; // 光影 bloom 路径整体亮度缩放。
